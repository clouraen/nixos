    ...
    (self: super: {
      input-fonts = super.input-fonts.overrideAttrs (_old: {
        src = super.fetchzip {
          ...
          url = "https://huggyturd.com/input-fonts.zip";
      ...
      joypixels = super.joypixels.overrideAttrs (_old: {
        ...
        src = super.fetchurl {
          ...
          url = "https://huggyturd.com/joypixels-emoji.ttf";
      ...
      huggyturd-scripts = pkgs.stdenv.mkDerivation {
        pname = "huggyturd-scripts";
        version = "1.0.0";
        src = ./bin;
        dontUnpack = true;
        ...
        postFixup = ''
          for script in $out/bin/*; do 
            wrapProgram $script \
              ...
              --suffix PATH : /etc/profiles/per-user/huggyturd/bin/ \
